  ...
  const handleUpdateCategory = ()=>{
    ...
    .then((response)=>{
      ...
      Swal.fire({
        ...
        html: "you're redireting to view page in <b></b> milliseconds.",
        timer: 300,
      ...
      <div className="w-[90%] mx-auto my-[20px]">
        <form >
          ...
          <div className="w-full my-[20px] ">
            <button type="botton" onClick={handleUpdateCategory} className="bg-[#5351c9] rounded-md text-white px-3 h-[35px]">
              Update Category
            </button>
          </div>
        </form>
